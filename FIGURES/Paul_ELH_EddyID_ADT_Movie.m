%% Paul_ELH_EddyID_ADT_Movie.m (version 1.1)
%Author: Paul Ernst
...
%--------------------------------------
%% Inputs; there are a few sticky plot settings in the Make Movie section; take note of that (they're marked with comments)
...
%         dates4later(i,qq) = convertCharsToStrings(list_ADT(qq).name);
